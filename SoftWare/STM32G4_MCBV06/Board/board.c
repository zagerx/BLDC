...
{
    i_abc[2]  = ((3.3f / (float)(1 << 12)) * (float)((int)adc_buf[0] - (1 << 11) - 60) * (1/AMPLIFICATION_FACTOR)) * (1/SAMPLING_RESISTANCE); 
    i_abc[1]  = ((3.3f / (float)(1 << 12)) * (float)((int)adc_buf[1] - (1 << 11) - 60) * (1/AMPLIFICATION_FACTOR)) * (1/SAMPLING_RESISTANCE);          //shunt_conductance_ = 1/0.001采样电阻;
    i_abc[0]  = ((3.3f / (float)(1 << 12)) * (float)((int)adc_buf[2] - (1 << 11) - 60) * (1/AMPLIFICATION_FACTOR)) * (1/SAMPLING_RESISTANCE);
}
