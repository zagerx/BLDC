#!/usr/bin/env python3
"""
vol_test.py - 正弦位置指令测试工具

用法:
    python3 vol_test.py

生成正弦位置指令，间隔20ms下发，幅值±36，完成一个周期后停止
"""
...
def main():
    parser = argparse.ArgumentParser(description='发送正弦位置指令测试')
